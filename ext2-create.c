...
void write_superblock(int fd) {
    ...
    superblock.s_r_blocks_count = 0; // Reserved blocks count - set as per your filesystem design
    ...
    superblock.s_max_mnt_count = 0xFFFF; // Set to 0xFFFF for 'unlimited'
    superblock.s_magic = EXT2_SUPER_MAGIC; // ext2 Signature, should be 0xEF53
...
void write_block_group_descriptor_table(int fd) {
	...
	block_group_descriptor.bg_free_blocks_count = NUM_FREE_BLOCKS;
	block_group_descriptor.bg_free_inodes_count = NUM_FREE_INODES;
	block_group_descriptor.bg_used_dirs_count = 2; //defined in spec... 2 directories
